...
async def build_sub_agent_prompt(
    ...
    lines = [
        ...
        'For expected_outputs with type="project", write the project files into the workspace with fs_write or bash; AChat will create and bind the project artifact automatically. Do not call write_artifact for project.',
        ...
        "For required_commands, you may run the command yourself, and AChat will also run it as a completion gate after your attempt. Use bash cwd instead of cd when running commands in subdirectories.",
